...
func _create_unlock_requirements_hud():
	...
	unlock_panel.position = Vector2(
		24,
		112
	)
	unlock_panel.size = Vector2(
		560,
		286
	)
	...
	unlock_title_label.text = "TIER 2 UNLOCK REQUIREMENTS"
	...
	unlock_tables_label = Label.new()
	unlock_tables_label.name = "Tier2TablesLabel"
	unlock_tables_label.position = Vector2(
		20,
		92
	)
	unlock_tables_label.size = Vector2(
		520,
		26
	)
	unlock_tables_label.add_theme_font_size_override(
		"font_size",
		18
	)
	unlock_tables_label.add_theme_color_override(
		"font_color",
		Color(1.0, 0.84, 0.42, 1.0)
	)
	unlock_tables_label.mouse_filter = \
		Control.MOUSE_FILTER_IGNORE
	unlock_panel.add_child(
		unlock_tables_label
	)

	unlock_coins_label = Label.new()
	unlock_coins_label.name = "Tier2CoinsLabel"
	unlock_coins_label.position = Vector2(
		20,
		124
	)
	unlock_coins_label.size = Vector2(
		520,
		26
	)
	unlock_coins_label.add_theme_font_size_override(
		"font_size",
		18
	)
	unlock_coins_label.add_theme_color_override(
		"font_color",
		Color(1.0, 0.84, 0.42, 1.0)
	)
	unlock_coins_label.mouse_filter = \
		Control.MOUSE_FILTER_IGNORE
	unlock_panel.add_child(
		unlock_coins_label
	)

	unlock_wines_label = Label.new()
	unlock_wines_label.name = "Tier2WinesLabel"
	unlock_wines_label.position = Vector2(
		20,
		156
	)
	unlock_wines_label.size = Vector2(
		520,
		26
	)
	unlock_wines_label.add_theme_font_size_override(
		"font_size",
		18
	)
	unlock_wines_label.add_theme_color_override(
		"font_color",
		Color(1.0, 0.84, 0.42, 1.0)
	)
	unlock_wines_label.mouse_filter = \
		Control.MOUSE_FILTER_IGNORE
	unlock_panel.add_child(
		unlock_wines_label
	)

	unlock_station_label = Label.new()
	unlock_station_label.name = "Tier2StationScoreLabel"
	unlock_station_label.position = Vector2(
		20,
		188
	)
	unlock_station_label.size = Vector2(
		520,
		26
	)
	unlock_station_label.add_theme_font_size_override(
		"font_size",
		18
	)
	unlock_station_label.add_theme_color_override(
		"font_color",
		Color(1.0, 0.84, 0.42, 1.0)
	)
	unlock_station_label.mouse_filter = \
		Control.MOUSE_FILTER_IGNORE
	unlock_panel.add_child(
		unlock_station_label
	)
...
func _create_live_status_hud():
	...
	status_title_label.text = "LIVE TASK STATUS"
	status_title_label.position = Vector2(
		16,
		12
	)
	status_title_label.size = Vector2(
		360,
		30
	)
	status_title_label.add_theme_font_size_override(
		"font_size",
		24
	)
	status_title_label.mouse_filter = \
		Control.MOUSE_FILTER_IGNORE
	...
	prompt_label.name = "CurrentMessage"
	...
	carrying_label.position = Vector2(
		16,
		226
	)
	carrying_label.size = Vector2(
		220,
		22
	)
	carrying_label.add_theme_font_size_override(
		"font_size",
		16
	)
	carrying_label.mouse_filter = \
		Control.MOUSE_FILTER_IGNORE
	status_panel.add_child(
		carrying_label
	)
	...
	tables_label.name = "FocusLabel"
	tables_label.position = Vector2(
		16,
		248
	)
	tables_label.size = Vector2(
		220,
		22
	)
	tables_label.add_theme_font_size_override(
		"font_size",
		16
	)
	tables_label.mouse_filter = \
		Control.MOUSE_FILTER_IGNORE
	status_panel.add_child(
		tables_label
	)
...
func update_hud():
	...
	if unlock_goal_label != null:
		unlock_goal_label.text = (
			"Goal: Unlock Tier 2 by clearing the shift requirements below."
		)
	...
	if carrying_label != null:
		carrying_label.text = (
			"Carrying: "
			+ _get_carrying_description()
		)

	if tables_label != null:
		tables_label.text = (
			"Focus: "
			+ _get_focus_description()
		)
...
func _update_mise_icon():
	...
	if mise_inventory_filled:
		...
		mise_label.text = (
			"MISE FULL\nUnassigned — normal tasks remain available"
		)
		return
