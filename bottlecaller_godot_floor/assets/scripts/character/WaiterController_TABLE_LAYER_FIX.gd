...
func _ready():
	...
	sprite.visible = true
	# The waiter root owns the draw layer. Keeping the sprite at zero
	# avoids accidentally adding another 100 levels through relative Z.
	sprite.z_index = 0
